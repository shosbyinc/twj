...
**Status:** Frozen for V1 collection · 17 August 2026
**Scenario ID:** `TWJ-R180-v1.0`
**Supersedes:** v1.6, retained at `docs/methodology-v1.6.md`; v1.5 to v1.0 also retained
...
- **Hong Kong** is the cheapest in the set at 5 m³ and among the dearest at 25 — twelve free cubic metres per statutory period, then rates that climb. It crosses every other city.
