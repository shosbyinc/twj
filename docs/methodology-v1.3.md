# TWJ WATER INDEX
> **Superseded by [Methodology v1.4](methodology-v1.4.md) on 17 August 2026.**
> Retained unaltered under Rule 7.3. §5.3 was rewritten: a refusal is shown
> publicly only where its reason is a verified characteristic of the tariff
> system or source record, never where it is our own unfinished evidence.
> No published figure moved.

## Methodology v1.4 supersedes this document

**Status:** Superseded. Frozen for V1 collection · 17 August 2026
**Scenario ID:** `TWJ-R180-v1.0`
**Supersedes:** v1.2, retained at `docs/methodology-v1.2.md`; v1.1 and v1.0 also retained
