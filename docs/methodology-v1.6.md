# TWJ WATER INDEX
> **Superseded by [Methodology v1.7](methodology-v1.7.md) on 17 August 2026.**
> Retained unaltered. v1.7 makes the observation unit a tariff jurisdiction
> rather than a city, makes the price curve the primary data object with 15 m³ as
> its canonical reference point, and enumerates the component ontology including
> the minimum bill. No published figure moved.

## Methodology v1.6 is superseded

**Status:** Superseded. Frozen for V1 collection · 17 August 2026
**Scenario ID:** `TWJ-R180-v1.0`
**Supersedes:** v1.5, retained at `docs/methodology-v1.5.md`; v1.4 to v1.0 also retained
