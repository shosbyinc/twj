# TWJ WATER INDEX
> **Superseded by [Methodology v1.2](methodology-v1.2.md) on 17 August 2026.**
> Retained unaltered under Rule 7.3. Four rules were added rather than changed:
> §2.5 reference connection, §2.6 time convention, §5.4 payable and structural
> price, §7.6 source completeness. The index was renamed to the TWJ Urban Water
> Tariff Index. No published figure moved.

## Methodology v1.1

**Status:** Superseded. Frozen for V1 collection · 17 August 2026
**Scenario ID:** `TWJ-R180-v1.0`
**Supersedes:** v1.0 (14 August 2026), retained at `docs/methodology-v1.0.md`
