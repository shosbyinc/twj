# TWJ WATER INDEX
> **Superseded by [Methodology v1.5](methodology-v1.5.md) on 17 August 2026.**
> Retained unaltered. External reconciliation ceased to be a gate condition and
> became a reported validation level; blockers are now classed material or
> validation gap. London returned to publication. No figure moved.

## Methodology v1.4 is superseded

**Status:** Superseded. Frozen for V1 collection · 17 August 2026
**Scenario ID:** `TWJ-R180-v1.0`
**Supersedes:** v1.3, retained at `docs/methodology-v1.3.md`; v1.2, v1.1 and v1.0 also retained
