...
**Supersedes:** v1.7, retained at `docs/methodology-v1.7.md`; v1.6 to v1.0 also retained
...
In anything TWJ ships — city records, grade reasons, withholding reasons, continuity notes, the corrections log, this document — a comparative or superlative predicate may not take a city, a utility or a country as its subject. Not *cheapest*, and equally not *weakest*, *thinnest*, *best-evidenced*, *least stable*, *most opaque*.
