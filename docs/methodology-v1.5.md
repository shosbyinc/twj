# TWJ WATER INDEX
> **Superseded by [Methodology v1.6](methodology-v1.6.md) on 17 August 2026.**
> Retained unaltered. v1.6 adds §3.8 tariff state, the `non_standardizable`
> component status, and the separation of publication from index eligibility.
> No published figure moved.

## Methodology v1.5 is superseded

**Status:** Superseded. Frozen for V1 collection · 17 August 2026
**Scenario ID:** `TWJ-R180-v1.0`
**Supersedes:** v1.4, retained at `docs/methodology-v1.4.md`; v1.3 to v1.0 also retained
